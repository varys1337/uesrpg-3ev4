...
import { getDifficultyByKey } from "./difficulties.js";

export { SKILL_DIFFICULTIES, getDifficultyByKey } from "./difficulties.js";

function collectCombatTNModifierEntries(actor, role, defenseType = null) {
  return collectCombatTNModifiersFromAE(actor, role, defenseType, {})?.entries ?? [];
}
