 ...
 * This function contains the full preparation pipeline for NPC actors.
 * 
...
export function prepareNPCData(actorContext, actorData) {
  ...
  // const t0 = actorContext._perfStart('_prepareNPCData');
  ...
  // Trait automation: apply trait-derived values to NPC (was missing before).
  ...
  if (actorContext._dwemerSphere(actorData) == true) {
...
actorContext._applyMovementRestrictionSemantics(actorData, actorSystemData);
  ...
  if (isNPC(actorContext) && actorSystemData.threat == "minorSolo") {
  ...
  } else if (isNPC(actorContext) && actorSystemData.threat == "minorGroup") {
    ...
    actorSystemData.lucky_numbers.ln9 = 0;
    actorSystemData.lucky_numbers.ln10 = 0;
  } else if (isNPC(actorContext) && actorSystemData.threat == "majorSolo") {
    actorSystemData.unlucky_numbers.ul1 = 0;
    ...
    actorSystemData.lucky_numbers.ln9 = 0;
    actorSystemData.lucky_numbers.ln10 = 0;
  } else if (isNPC(actorContext) && actorSystemData.threat == "majorGroup") {
    actorSystemData.unlucky_numbers.ul1 = 0;
    actorSystemData.unlucky_numbers.ul2 = 0;
    ...
    actorSystemData.lucky_numbers.ln9 = 0;
    actorSystemData.lucky_numbers.ln10 = 0;
  } else if (isNPC(actorContext) && actorSystemData.threat == "deadlySolo") {
    actorSystemData.unlucky_numbers.ul1 = 0;
    actorSystemData.unlucky_numbers.ul2 = 0;
    actorSystemData.unlucky_numbers.ul3 = 0;
    ...
    actorSystemData.lucky_numbers.ln9 = 0;
    actorSystemData.lucky_numbers.ln10 = 0;
  } else if (isNPC(actorContext) && actorSystemData.threat == "deadlyGroup") {
    actorSystemData.unlucky_numbers.ul1 = 0;
    actorSystemData.unlucky_numbers.ul2 = 0;
    actorSystemData.unlucky_numbers.ul3 = 0;
    actorSystemData.unlucky_numbers.ul4 = 0;
    ...
    actorSystemData.lucky_numbers.ln9 = 0;
    actorSystemData.lucky_numbers.ln10 = 0;
  } else if (isNPC(actorContext) && actorSystemData.threat == "legendarySolo") {
    actorSystemData.unlucky_numbers.ul1 = 0;
    actorSystemData.unlucky_numbers.ul2 = 0;
    actorSystemData.unlucky_numbers.ul3 = 0;
    actorSystemData.unlucky_numbers.ul4 = 0;
  ...
  } else if (isNPC(actorContext) && actorSystemData.threat == "legendaryGroup") {
    actorSystemData.unlucky_numbers.ul1 = 0;
    actorSystemData.unlucky_numbers.ul2 = 0;
    actorSystemData.unlucky_numbers.ul3 = 0;
    actorSystemData.unlucky_numbers.ul4 = 0;
  ...
  // PERF end
  // actorContext._perfEnd('_prepareNPCData', t0);
}
